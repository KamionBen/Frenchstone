...
class TourEnCours:
    ...
    def apply_effects(self, carte, target=None):
        ...
        if carte.type == "Serviteur" and not "titan" in carte.effects:
            if ("charge" in carte.effects or "ruée" in carte.effects) and not (carte.is_dead() or "rale_applied" in carte.effects):
            ...
            if "cri de guerre" in carte.effects and not (carte.is_dead() or "rale_applied" in carte.effects):
                    ...
                    if target is not None:
                            ...
                            if "alive" in carte.effects["cri de guerre"][1]:
                                ...
                                if "atq_serv" in carte.effects["cri de guerre"][1]:
                                    ...
                                    if "ruée" in carte.effects["cri de guerre"][1]:
                                        ...
                                        target.remaining_atk = 1 if target.remaining_atk == -1 else target.remaining_atk
                        ...
                        if "self" in carte.effects["cri de guerre"][1]:
                            if carte.name == "Mousse de la voile sanglante" :
                                ...
                                carte.attack += len(player.dead_this_turn) + len(adv.dead_this_turn)
                                carte.base_attack += len(player.dead_this_turn) + len(adv.dead_this_turn)
                                carte.health += len(player.dead_this_turn) + len(adv.dead_this_turn)
                                carte.base_health += len(player.dead_this_turn) + len(adv.dead_this_turn)
                            elif "if_atq_sup4" in carte.effects["cri de guerre"][1] and [x.attack for x in player.servants if x != carte and not "en sommeil" in x.effects] \
                                ...
                                if "ruée" in carte.effects["cri de guerre"][1]:
                                    ...
                                    carte.remaining_atk = 1 if carte.remaining_atk == -1 else carte.remaining_atk
                            ...
                            if "tous" in carte.effects["cri de guerre"][1]:
                                ...
                                if "invocation" in carte.effects["cri de guerre"][1]:
                                    if "Treant taunt" in carte.effects["cri de guerre"][1]:
                                        for _ in range(2):
                                            self.invoke_servant(get_card("Treant taunt", all_servants), 0)
                ...
                if "damage" in carte.effects["cri de guerre"]:
                    if target is not None:
                        ...
                        if [x.name for x in player.servants] and "Enchanteur" in [x.name for x in player.servants] and type(target) == Card:
                            target.damage(2 * carte.effects["cri de guerre"][2], toxic=True if "toxicite" in carte.effects else False)
                        else:
                        ...
                        if "self_Players" in carte.effects["cri de guerre"][1]:
                            player.damage(carte.effects["cri de guerre"][2], toxic=True if "toxicite" in carte.effects else False)
                    else:
                        if carte.effects["cri de guerre"][1][0] == "tous":
                                    ...
                                    for n in range(0, carte.effects["cri de guerre"][1][-1]):
                                        if [x for x in [adv] + adv.servants.cards if x.health > 0]:
                                            ...
                                            if [x.name for x in player.servants] and "Enchanteur" in [x.name for x in
                                                ...
                                                random_target.damage(2 * carte.effects["cri de guerre"][2], toxic=True if "toxicite" in carte.effects else False)
                                    ...
                                    if "conditional" in carte.effects["cri de guerre"][1]:
                                        if "heros_allié_attack" in carte.effects["cri de guerre"][1] and player.has_attacked > 0:
                                            for card in [adv] + adv.servants.cards:
                                                if [x.name for x in player.servants] and "Enchanteur" in [x.name for x in player.servants] and type(card) == Card:
                                                    card.damage(2*carte.effects["cri de guerre"][2], toxic=True if "toxicite" in carte.effects else False)
                                                else:
                                                    card.damage(carte.effects["cri de guerre"][2], toxic=True if "toxicite" in carte.effects else False)
                                    else:
                                        for card in [adv] + adv.servants.cards:
                                            if [x.name for x in player.servants] and "Enchanteur" in [x.name for x in
                                                                                                      player.servants] and type(
                                                    card) == Card:
                                                card.damage(2 * carte.effects["cri de guerre"][2], toxic=True if "toxicite" in carte.effects else False)
                                            else:
                                                card.damage(carte.effects["cri de guerre"][2], toxic=True if "toxicite" in carte.effects else False)
                            ...
                            adv.damage(3, toxic=True if "toxicite" in carte.effects else False)
                        ...
                        if "ennemi" in carte.effects["cri de guerre"][1] and target is not None:
                            ...
                            if carte.effects["cri de guerre"][2] == "servs_atq":
                                for servant in player.servants.cards:
                                    if servant != target:
                                        servant.attack += target.attack
                                        servant.base_attack += target.attack
                                target.blessure = 1000
                ...
                if "reinit_hp" in carte.effects["cri de guerre"]:
                ...
                if "spell_damage" in carte.effects["cri de guerre"]:
                        ...
                        if target is not None:
                            ...
                            if carte.effects["cri de guerre"][2] == "several":
                                ...
                                if type(carte.effects["cri de guerre"][2]) == list:
                                    ...
                                    if "serviteur" in carte.effects["cri de guerre"][1]:
                                        if "Bête" in carte.effects["cri de guerre"][1]:
                                            card_to_draw = Card(**random.choice([x for x in all_servants if "Bête" in x["genre"] and x["decouvrable"] == 1]))
                                    elif "sort" in carte.effects["cri de guerre"][1]:
                                        if "Mage" in carte.effects["cri de guerre"][1]:
                                            card_to_draw = Card(**random.choice([x for x in all_spells if x["classe"] == "Mage" and x["decouvrable"] == 1]))
                                    else:
                                    ...
                                    if len([x for x in player.deck if x.type == "Sort"]) >= carte.effects["cri de guerre"][2]:
                                        ...
                                        if "dmg_if_givre" in carte.effects["cri de guerre"][1] and len([x for x in spells_to_draw if "Givre" in x.genre]) == 2:
                                            for entity in [adv] + adv.servants.cards:
                                                entity.damage(2, toxic=True if "toxicite" in carte.effects else False)
                ...
                if "entrave" in carte.effects["cri de guerre"]:
                    ...
                    if "ennemi" in carte.effects["cri de guerre"][1]:
                        adv.curses.append(carte.effects["cri de guerre"][2])
                    ...
                    if "allié" in carte.effects["cri de guerre"][1] and len(player.servants) + len(player.lieux) < 7:
                        ...
                        if "aléatoire" in carte.effects["cri de guerre"][1]:
                            ...
                            for compagnon in invoked_servants:
                                self.invoke_servant(compagnon, 0)
                            ...
                            if "boost" in carte.effects["cri de guerre"][1]:
                                if "until_cadavre" in carte.effects["cri de guerre"][1]:
                                    ...
                                    for creature in [x for x in player.servants if x.name == "Fan de voilegroin"]:
                                        creature.attack += max(0, player.attack - player.atk_this_turn)
                                        creature.base_attack += max(0, player.attack - player.atk_this_turn)
                                        creature.health += max(0, player.armor - player.armor_this_turn)
                                        creature.base_health += max(0, player.armor - player.armor_this_turn)
                    ...
                    if "board" in carte.effects["cri de guerre"][1]:
                        ...
                        for card in board:
                            if len(player.servants) + len(player.lieux) < 7 and card != carte:
                                self.invoke_servant(get_card(card.name, all_servants), 0)
                if "decouverte" in carte.effects["cri de guerre"]:
                    if target is not None:
                            ...
                            if "sort" in carte.effects["cri de guerre"][2]:
                                ...
                                if "legendaire" in carte.effects["cri de guerre"][2]:
                                    ...
                                    if "in_deck" in carte.effects["cri de guerre"][2] and [x for x in player.deck if x.type == "Serviteur" and "Bête" in x.genre]:
                                        self.plt.cards_chosen = self.choice_decouverte(carte, card_group=CardGroup([get_card(x.name, all_servants) for x in player.deck if x.type == "Serviteur" and "Bête" in x.genre]))
                                    else:
                                        self.plt.cards_chosen = self.choice_decouverte(carte, type="serviteur", genre=["Bête"])
                ...
                if "permanent_buff" in carte.effects["cri de guerre"]:
                ...
                if "damage" in carte.effects["soif de mana"]:
                    if target is not None:
                        if [x.name for x in player.servants] and "Enchanteur" in [x.name for x in
                            ...
                            target.damage(2 * carte.effects["soif de mana"][2], toxic=True if "toxicite" in carte.effects else False)
                        else:
                                    ...
                                    try:
                                        for n in range(0, carte.effects["soif de mana"][1][3]):
                                            ...
                                            if [x.name for x in player.servants] and "Enchanteur" in [x.name for
                                                                                                      x in
                                                                                                      player.servants] and random_target in adv.servants:
                                                random_target.damage(2 * carte.effects["soif de mana"][2], toxic=True if "toxicite" in carte.effects else False)
                                            else:
            ...
            if "magnetisme" in carte.effects and not (carte.is_dead() or "rale_applied" in carte.effects) and target is not None:
                    ...
                    if type(target) in (Player, Card):
                        if [x.name for x in player.servants] and "Enchanteur" in [x.name for x in player.servants] and target in adv.servants:
                            if type(carte.effects["rale d'agonie"][2]) == list:
                                target.damage(2 * random.choice(carte.effects["rale d'agonie"][2]), toxic=True if "toxicite" in carte.effects else False)
                            else:
                                target.damage(2 * carte.effects["rale d'agonie"][2], toxic=True if "toxicite" in carte.effects else False)
                        else:
                            if type(carte.effects["rale d'agonie"][2]) == list:
                        ...
                        for card in target:
                            if [x.name for x in player.servants] and "Enchanteur" in [x.name for x in
                                                                                      player.servants] and target in adv.servants:
                                card.damage(2 * carte.effects["rale d'agonie"][2], toxic=True if "toxicite" in carte.effects else False)
                            else:
                    ...
                    if type(target) in (Player, Card):
                        if [x.name for x in player.servants] and "Enchanteur" in [x.name for x in
                            ...
                            if type(carte.effects["rale d'agonie2"][2]) == list:
                                target.damage(2 * random.choice(carte.effects["rale d'agonie2"][2]), toxic=True if "toxicite" in carte.effects else False)
                            else:
                                target.damage(2 * carte.effects["rale d'agonie2"][2], toxic=True if "toxicite" in carte.effects else False)
                        else:
                            if type(carte.effects["rale d'agonie2"][2]) == list:
                        ...
                        for card in target:
                            if [x.name for x in player.servants] and "Enchanteur" in [x.name for x in
                                                                                      player.servants] and target in adv.servants:
                                card.damage(2 * carte.effects["rale d'agonie2"][2], toxic=True if "toxicite" in carte.effects else False)
                            else:
            ...
            if player.boost_next:
                for boost in player.boost_next:
                    if boost[0] in carte.genre:
                        carte.attack += boost[1][0]
                        carte.base_attack += boost[1][0]
                        carte.health += boost[1][1]
                        carte.base_health += boost[1][1]
                ...
                if target is not None:
                    if type(carte.effects["damage"]) == list:
                        if "cadavres_spent" in carte.effects["damage"]:
                            ...
                            target.damage(carte.effects["damage"], toxic=True if "toxicite" in carte.effects else False)
                    ...
                    if "cleave" in carte.effects:
                        if target in adv.servants:
                            ...
                            try:
                                ...
                                cible_droite.damage(carte.effects["damage"] + player.spell_damage,
                                                    toxic=True if "toxicite" in carte.effects else False)
                            except:
                                pass
                    ...
                    if "except_self" in carte.effects["damage"][0]:
                        ...
                        if "aléatoire" in carte.effects["damage"][0]:
                            potential_targets = [adv] + adv.servants.cards
                            targets = random.sample(potential_targets, min(carte.effects["damage"][0][-1], len(potential_targets)))
                ...
                if "allié" in carte.effects["drain"] and "Mort-vivant" in carte.effects["drain"] and [x for x in player.servants if "Mort-vivant" in x.genre]:
                    for creature in [x for x in player.servants if "Mort-vivant" in x.genre]:
                        if not target.is_dead():
                            target.attack -= carte.effects["drain"][-1][0]
                            target.base_attack -= carte.effects["drain"][-1][0]
                            target.health -= carte.effects["drain"][-1][1]
                            target.base_health -= carte.effects["drain"][-1][1]
                            creature.attack += carte.effects["drain"][-1][0]
                            creature.base_attack += carte.effects["drain"][-1][0]
                            creature.health += carte.effects["drain"][-1][1]
                            creature.base_health += carte.effects["drain"][-1][1]
            ...
            if "gel" in carte.effects:
                ...
                if target in player.servants:
                    player.servants.remove(target)
                    self.invoke_servant(get_card(carte.effects["mutation"], all_servants), 0)
                else:
                    adv.servants.remove(target)
                    self.invoke_servant(get_card(carte.effects["mutation"], all_servants), 1)
            elif "resurrect" in carte.effects:
                if "allié" in carte.effects["resurrect"] and "tous" in carte.effects["resurrect"]:
                    if "under2_cost" in carte.effects["resurrect"] and len(player.servants) < 7 and player.dead_under2:
                        cards_to_ressurect = random.sample(player.dead_under2, min(7 - len(player.servants), len(player.dead_under2)))
                    ...
                    if "Bête" in carte.effects["resurrect"] and "cost_sup5" in carte.effects["resurrect"] and len(player.servants) < 7 and player.dead_beast_sup5:
                        cards_to_ressurect = random.sample(player.dead_beast_sup5, min(7 - len(player.servants), len(player.dead_beast_sup5)))
                        cards_to_ressurect = [get_card(x.name, all_servants) for x in cards_to_ressurect]
                        player.servants.cards = player.servants.cards + cards_to_ressurect
                ...
                if type(carte.effects["add_hand"]) == CardGroup:
                    ...
                    if "serviteur" in carte.effects["add_hand"][0]:
                        if "colossal" in carte.effects["add_hand"][0]:
                            ...
                            player.hand.add(card_to_add)
                    elif "sort" in carte.effects["add_hand"][0]:
                    ...
                    if "Élémentaire" in carte.effects["add_hand"] and "123" in carte.effects["add_hand"]:
                        for i in range(3):
                            player.hand.add(Card(**random.choice([x for x in all_servants if "Élémentaire" in x["genre"] and x["cost"] == i + 1 and x["decouvrable"] == 1])))
            ...
            if "pioche" in carte.effects:
                if "allié" in carte.effects["pioche"]:
                    if "arme" in carte.effects["pioche"]:
                        ...
                        elif "if_not_serv" in carte.effects and player.hand[-1].type != "Serviteur":
                ...
                for creature in carte.effects["invocation"]:
                    if len(adv.servants) + len(adv.lieux) < 7:
                        ...
                        if "trigger" in carte.effects:
                            ...
                            self.invoke_servant(invoked_creature, 1)
                        else:
                            self.invoke_servant(invoked_creature, 0)
                        if "boosted_invoked" in carte.effects:
                            invoked_creature.attack += carte.effects["boosted_invoked"][0]
                            invoked_creature.base_attack += carte.effects["boosted_invoked"][0]
                            invoked_creature.health += carte.effects["boosted_invoked"][1]
                            invoked_creature.base_health += carte.effects["boosted_invoked"][1]
                        ...
                        if "spend_cadavre" in carte.effects and player.cadavres >= carte.effects["spend_cadavre"][0] and "reincarnation" in carte.effects["spend_cadavre"]:
                            ...
                            invoked_creature.attack += player.reliques - 1
                            invoked_creature.base_attack += player.reliques - 1
            ...
            if "attack+invoke" in carte.effects:
                if "serviteur" in carte.effects["attack+invoke"] and "allié" in carte.effects["attack+invoke"]:
                    ...
                    for creature in carte.effects["attack+invoke"]:
                        ...
                        if len(adv.servants) + len(adv.lieux) < 7:
                            self.invoke_servant(to_invoke, 1)
                            try:
                                if not target.is_dead():
            ...
            if "reduc" in carte.effects and not "self" in carte.effects["reduc"]:
                if "permanent" in carte.effects["reduc"] and "main" in carte.effects["reduc"] and "sort" in carte.effects["reduc"]:
                ...
                if "graine" in carte.effects["reveil"]:
                    for servant in [x for x in player.servants if "graine" in x.effects and "en sommeil" in x.effects]:
                        ...
                        if servant.effects["en sommeil"] == 0:
                            ...
                            servant.remaining_atk = 1 if "ruée" in servant.effects else 0
            ...
            if "decouverte" in carte.effects:
                if "tous" in carte.effects["decouverte"]:
                    ...
                    if "sort" in carte.effects["decouverte"] and [x for x in player.deck if x.type == "Sort"]:
                        self.plt.cards_chosen = self.choice_decouverte(carte, card_group=CardGroup([x for x in player.deck.cards if x.type == "Sort"]))
            ...
            if "hero_power_replacement" in carte.effects:
                ...
                if "héros" in carte.effects["permanent_buff"][1]:
            ...
            if "random_spell" in carte.effects["use"]:
                ...
                for i in range(carte.effects["use"][2]):
                    played_card = Card(**random.choice(
                        [x for x in all_spells if x["decouvrable"] == 1]))
                    if "choix_des_armes" in carte.effects:
                        choice = random.randint(0, 1)
                        played_card.effects[played_card.effects["choix_des_armes"][choice][0]] = played_card.effects["choix_des_armes"][choice][1]
                        played_card.effects.pop("choix_des_armes")
            ...
            if "rale d'agonie" in carte.effects and (carte.is_dead() or "rale_applied" in carte.effects):
                if "invocation" in carte.effects["rale d'agonie"] and len(player.servants) + len(player.lieux) < 7:
                    if "stack" in carte.effects:
                        ...
                        servant_invoked.base_cost += carte.effects["stack"]
                        servant_invoked.attack += carte.effects["stack"]
                        servant_invoked.base_attack += carte.effects["stack"]
                        servant_invoked.health += carte.effects["stack"]
                        servant_invoked.base_health += carte.effects["stack"]
                    elif "aléatoire" in carte.effects["rale d'agonie"][1]:
                        if "Bête" in carte.effects["rale d'agonie"][1]:
                            invoked_servant = Card(**random.choice([x for x in all_servants if "Bête" in x["genre"] and x["cost"] == carte.effects["rale d'agonie"][2]]))
                            self.invoke_servant(invoked_servant, 0)
                    else:
                        ...
                        if "conditional" in servant.effects["aura"][1] and "sort" in servant.effects["aura"][1]:
                            if carte.type == "sort":
                                ...
                                for servant2 in adv.servants:
                                    if [x.name for x in player.servants] and "Enchanteur" in [x.name for x in
                                                                                              player.servants]:
                                        servant2.damage(2 * servant.effects["aura"][2], toxic=True if "toxicite" in servant.effects else False)
            ...
            if "add_hand" in servant.effects["aura"]:
                if "conditional" in servant.effects["aura"][1]:
                    if "if_spell" in servant.effects["aura"][1] and carte.type == "Sort":
                        ...
                        player.hand.add(Card(**random.choice([x for x in all_cards if "marginal" in x["effects"]])))
        ...
        if carte.type.lower() == "sort":
            ...
            if "counter" in [x.effects["aura"][0] for x in adv.servants if "aura" in x.effects] and "sort" in [x.effects["aura"][1] for x in adv.servants if "aura" in x.effects]:
                ...
                if "topior" in player.permanent_buff and "Nature" in carte.genre:
                    self.invoke_servant(get_card("Minigazzor", all_servants), 0)
            ...
            if len(player.servants) + len(player.lieux) < 7:
                ...
                if "Naga" in carte.genre:
                    ...
                    elif [x for x in player.hand if "hero_attack" in x.effects and type(x.effects["hero_attack"]) == list and "if_naga" in x.effects["hero_attack"]]:
                    ...
                    elif [x for x in player.hand if "add_hand" in x.effects and "if_naga" in x.effects["add_hand"]]:
                        for card in [x for x in player.hand if "add_hand" in x.effects and type(x.effects["hero_attack"]) == list and "if_naga" in x.effects["add_hand"]]:
                            card.effects["add_hand"][0] = ["allié"]
                    elif [x for x in player.hand if "boosted_invoked" in x.effects and "if_naga" in x.effects["boosted_invoked"]]:
                    ...
                    elif [x for x in player.hand if "pioche" in x.effects and "if_naga" in x.effects["pioche"]]:
                ...
                self.apply_effects(carte, target)
                if adv.secrets and "if_serv_played" in [x.effects["trigger"] for x in adv.secrets]:
                    for secret in adv.secrets:
            ...
            self.apply_effects(carte)
        if adv.secrets and "if_three_played" in [x.effects["trigger"] for x in adv.secrets] and player.cards_this_turn >= 3:
            for secret in adv.secrets:
                    ...
                    if "serviteur" in attaquant.effects["aura"][1] and "Bête" in attaquant.effects["aura"][1]:
                        if [x for x in player.deck if x.type == "Serviteur" and "Bête" in x.genre]:
                            ...
                            if "boost_caracs" in attaquant.effects["aura"][1]:
                                attaquant.attack += drawn_servant.attack
                                attaquant.base_attack += drawn_servant.attack
                                attaquant.health += drawn_servant.health
                                attaquant.base_health += drawn_servant.health
                ...
                if [x.name for x in player.servants] and "Enchanteur" in [x.name for x in player.servants] and type(cible) == Card:
                    if "aura" in attaquant.effects and "Neptulon" in attaquant.effects["aura"] and [x for x in player.servants if x.name == "Main de neptulon"]:
                        for main_nept in [x for x in player.servants if x.name == "Main de neptulon"]:
                            cible.damage(2 * main_nept.attack, toxic=True if "toxicite" in main_nept.effects else False)
                    else:
                        cible.damage(2 * attaquant.attack, toxic=True if "toxicite" in attaquant.effects else False)
                        if "cleave" in attaquant.effects and type(cible) == Card:
                            index_target = adv.servants.cards.index(cible)
                            if index_target != 0:
                                cible_gauche = adv.servants[index_target - 1]
                                cible_gauche.damage(2 * attaquant.attack, toxic=True if "toxicite" in attaquant.effects else False)
                            try:
                                cible_droite = adv.servants[index_target + 1]
                                cible_droite.damage(2 * attaquant.attack, toxic=True if "toxicite" in attaquant.effects else False)
                            except:
                                pass
                else:
                            ...
                            if "if_attack" in attaquant.weapon.effects["aura"][1]:
                                if "damage" in attaquant.weapon.effects["aura"] and "heros" in attaquant.weapon.effects["aura"][1] and "ennemi" in attaquant.weapon.effects["aura"][1]:
                                    ...
                                    if "board" in attaquant.weapon.effects["aura"][1] and player.servants:
                                        for creature in player.servants:
                                            creature.attack += 1
                                            creature.base_attack += 1
                                            creature.health += 1
                                            creature.base_health += 1
                                ...
                                if "invocation" in attaquant.weapon.effects["aura"]:
                                    if "Combattant vrykul" in attaquant.weapon.effects["aura"]:
                                        self.invoke_servant(get_card("Combattant vrykul", all_servants), 0)
    ...
    def choice_decouverte(self, carte, type=None, genre=None, classe=None, other=None, card_group=None, reduc=None):
        ...
        if type == "serviteur":
            ...
            if classe:
                ...
                if len(player.ecoles_jouees) != 8:
                    ...
                    group_filtered = [x for x in all_spells if x["decouvrable"] == 1]
            elif other == "relique":
                group_filtered = [x for x in all_spells if "Relique" in x["name"] and x["decouvrable"] == 1 and x["name"] != carte.name]
            ...
            if other == "vert":
                ...
                group_filtered = [x for x in all_cards if x["decouvrable"] == 1 and x["name"] != carte.name and "marginal" in x["effects"]]
            else:
        ...
        if reduc is not None:
            for element in discovery:
                if other == "temp_turn":
                    element.effects["temp_reduc"] = reduc
    ...
    def decouverte(self, cards, choice, type_dec="decouverte", target=None):
        ...
        if type_dec == "decouverte":
            if choice != 3:
                if [x for x in player.hand if x.name == "Jeune naga" and x.effects["cri de guerre"][2] == ""]:
                    ...
                    if cards[choice].type == "Serviteur":
                        ...
                        self.apply_effects(cards[choice])
                elif player.last_card.name in ["Piege forge par les titans", "Piege forge par les titans forge", "Harmoniciste soliste"]:
                    self.apply_effects(cards[choice])
            ...
            if player.last_card.name == "Dompteur du fleau" and "second_time" in player.last_card.effects:
                ...
                player.hand.cards[-2].attack += player.hand.cards[-1].attack
                player.hand.cards[-2].base_attack += player.hand.cards[-1].base_attack
                player.hand.cards[-2].health += player.hand.cards[-1].health
                player.hand.cards[-2].base_health += player.hand.cards[-1].base_health
        ...
        elif type_dec == "dragage" and player.deck.cards:
            try:
                player.deck.cards.remove(cards[choice])
                if player.weapon.name == "Fusil harpon" and cards[choice].type == "Serviteur" and "Bête" in cards[choice].genre:
                    cards[choice].base_cost = max(0, cards[choice.base_cost] - 2)
                if player.last_card.name == "Cab o tron" and cards[choice].cost == 1 and cards[choice].type == "Serviteur":
                    self.invoke_servant(cards[choice], 0)
    ...
    def fin_du_tour(self):
                ...
                if "boost" in servant.effects["aura"] and "self" in servant.effects["aura"][1]:
                    ...
                    if "until_full" in servant.effects["aura"][1]:
                        ...
                        if "copy" in servant.effects["aura"][1]:
                            ...
                            player.servants.add(invoked_servant)
                        else:
                            player.servants.add(get_card(servant.effects["aura"][2], all_servants))
        ...
        for card in player.hand:
            if "temp_reduc" in card.effects:
                card.base_cost = min(card.base_cost + card.effects["temp_reduc"], get_card(card.name, all_cards).base_cost)
        ...
        if adv.secrets.cards and "if_zero_mana" in [x.effects["trigger"] for x in adv.secrets] and player.mana == 0:
    ...
    def tour_ia_minmax(self, plateau, logs, action, generate_logs=True):
        ...
        if action == 0:
            ...
            if (action - 265) % 16 == 0:
                ...
                target = adv.servants[(action - 273) % 16]
                    ...
                    if adv.secrets and "if_serv_dies" in [x.effects["trigger"] for x in adv.secrets]:
                        for secret in adv.secrets:
                            if secret.effects["trigger"] == "if_serv_dies":
                                ...
                                secret.effects[secret.effects["secret"][0]] = secret.effects["secret"][1]
                                secret.effects.pop("secret")
                                TourEnCours(plateau).apply_effects(secret)
                                adv.secrets.remove(secret)
                                adv.secrets_declenches += 1
